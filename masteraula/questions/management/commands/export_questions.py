...
class Command(BaseCommand):
    ...
    fields = ['Autor','Origem','Ano','Grau de dificuldade','Disciplinas','Nível de ensino','Enunciado','Resolução','Alternativa Correta','Alternativa A','Alternativa B','Alternativa C','Alternativa D','Alternativa E']
    ...
    def handle(self, *app_labels, **options):
        ...
        for q in question:
            ...
            statement = remove_tags(q.statement)
            ...
            for a in answer:      
                if a.is_correct:
                    resp = remove_tags(a.text)

            fields = [q.author, q.source, q.year, difficulty, disc, teaching_level, statement, q.resolution, resp]

            for a in answer:
                alternative = remove_tags(a.text)
                fields += [alternative]
